...
public class IndeterminateRadioButton extends AppCompatRadioButton implements IndeterminateCheckable {
    ...
    public IndeterminateRadioButton(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.indeterminateRadioButtonStyle);
    }
    ...
    public IndeterminateRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            final boolean indeterminate = a.getBoolean(R.styleable.IndeterminateRadioButton_indeterminate, false);
            if (indeterminate) {
                setState(null);
            }
        } finally {
