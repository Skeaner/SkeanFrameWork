...
public abstract class SimpleClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public static class DefalutSimpleClickListener extends SimpleClickListener{
        ...
        @Override
        public void onClickEmptySpace(BaseQuickAdapter adapter) {
...
//                mPressedView.setPressed(true);
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            if (mIsPrepressed ) {
                ...
                else onClickEmptySpace(baseQuickAdapter);
            }
            return true;
        }
    ...
    public abstract void onClickEmptySpace(BaseQuickAdapter adapter);
